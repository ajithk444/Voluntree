...
class VictimRouteHelperViewModel {
  final VictimRouteHelperRepository repository;
  final IVictimRouteHelperInfoPage view;

  VictimRouteHelperViewModel({@required this.repository, @required this.view});
  ...
  void getVictims() async {
    ...
    view.onVictimsReceived(victims);
  }
